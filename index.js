...
const nextButton = document.getElementById("nextModalImage");
const prevButton = document.getElementById("prevModalImage");

nextButton.addEventListener("click", nextModalImage);
prevButton.addEventListener("click", prevModalImage);
